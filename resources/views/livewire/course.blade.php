                        ...
                        <div class="card" style="background-color: #1f2937; border-radius: 1rem;">
                            <div class="card-body">
                                ...
                                <form class="row g-3" data-bitwarden-watching="1">
                                    <div class="col-12">
                                        <label for="inputNanme4" class="form-label" style="color: #ffffff">Course List: *dropdown</label>
                                        <input type="text" class="form-control" id="inputNanme4">
                                    </div>
                                    <div class="col-6">
                                        <label for="inputEmail4" class="form-label" style="color: #ffffff">Subject:</label>
                                        <input type="email" class="form-control" id="inputEmail4">
                                    </div>
                                    <div class="col-6">
                                        <label for="inputNanme4" class="form-label" style="color: #ffffff">Year:</label>
                                    ...
                                    <div class="col-12">
                                        <label for="inputNanme4" class="form-label" style="color: #ffffff">Room: *dropdown</label>
                                        <input type="text" class="form-control" id="inputNanme4">
                                    </div>
                                    <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <label for="inputNanme4" class="form-label" style="color: #ffffff">Time Start:</label>
                                        <input type="text" class="form-control" id="inputNanme4">
                                    </div>
                                    <div class="col-12">
                                        <label for="inputNanme4" class="form-label" style="color: #ffffff">Time End:</label>
                                        <input type="text" class="form-control" id="inputNanme4">
                                    </div>
                                    <div class="col-12">
                                        <label for="inputNanme4" class="form-label" style="color: #ffffff">Block:</label>
                                        <input type="text" class="form-control" id="inputNanme4">
                                    </div>
                                            ...
                                            <div class="container text-center">
                                                <div class="row g-2">
                                                    <div class="col-8 text-start">
                                                        <div class="p-1">Custom column padding</div>
                                                        <div class="p-1">Custom column padding</div>
                                                    </div>
                                                    <div class="col-4">
